/*
	SharpContent specific enhancements for FreeTextBox
*/
...
FTB_FreeTextBox.prototype.CreateLink = function() {
	...
	url += "&ftb=" + this.id;
	var scplink = window.open(url,'scplink','width=400,height=350,toolbars=0,resizable=1');
	scplink.focus();
};
...
FTB_FreeTextBox.prototype.SelectSmiley = function() {
	...
	url = url.replace(/\{0\}/g,url); 
	url += "&ftb=" + this.id;
	var scplink = window.open(url,'scplink','width=400,height=200,toolbars=0,resizable=1');
	scplink.focus();
};
