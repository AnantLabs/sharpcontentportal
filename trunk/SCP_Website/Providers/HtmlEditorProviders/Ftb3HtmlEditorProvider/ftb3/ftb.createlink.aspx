<%@ Page Language="C#" ValidateRequest="false" Trace="false" AutoEventWireup="true" Inherits="SharpContent.HtmlEditor.FTBCreateLink" %>
		...
		function insertLink() {
			...
			switch(myOption)
			{
				case 0:
					...
					break    
				case 1:
					href = document.getElementById('SCPDomainNameTabid').value + document.getElementById('ctlURL_cboTabs').value;
					break
				case 2:
					var mylist=document.getElementById("ctlURL_cboFiles")
					href = document.getElementById('SCPDomainNameFilePath').value + document.getElementById('ctlURL_cboFolders').value + mylist.options[mylist.selectedIndex].text;
					break
				default:
