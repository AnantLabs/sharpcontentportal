<%@ Control AutoEventWireup="true" CodeFile="LanguagePack.ascx.cs" Inherits="SharpContent.Services.Localization.LanguagePack" Language="C#" %>
...
<table>
    <tr>
        <td class="SubHead" valign="middle" width="150">
            <scp:Label ID="lbLocale" runat="server" ControlName="cboLanguage" Text="Resource Locale" />
        </td>
        <td valign="top">
    ...
    <tr>
        <td class="SubHead" valign="middle" width="150">
            <scp:Label ID="lblType" runat="server" ControlName="cboLanguage" Text="Resource Locale" />
        </td>
        <td valign="top">
    ...
    <tr>
        <td class="SubHead" valign="middle" width="150">
            <scp:Label ID="lblName" runat="server" ControlName="cboLanguage" Text="Resource Locale" />
        </td>
        <td valign="top">
...
<asp:Panel ID="pnlLogs" runat="server" Visible="False">
    <scp:SectionHead ID="dshBasic" runat="server" CssClass="Head" IncludeRule="True" ResourceKey="LogTitle" Section="divLog" Text="Language Pack Log" />
