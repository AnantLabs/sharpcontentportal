<%@ Control Inherits="SharpContent.Modules.Admin.Host.HostSettingsModule" Language="C#" AutoEventWireup="true" CodeFile="HostSettings.ascx.cs" %>
...
<%@ Register TagPrefix="scp" TagName="FriendlyUrls" Src="~/admin/Host/FriendlyUrls.ascx" %>
...
<table class="Settings" cellspacing="2" cellpadding="2" width="560" summary="Host Settings Design Table"
	...
	<tr>
		<td style="width: 560px;" valign="top">
			<scp:sectionhead id="dshBasic" runat="server" cssclass="Head" text="Basic Settings" section="tblBasic"
			...
			<table id="tblBasic" cellspacing="0" cellpadding="2" width="525" summary="Basic Settings Design Table"
				...
				<tr>
					...
					<td valign="top" style="width: 475;">
						<scp:sectionhead id="dshConfiguration" cssclass="Head" runat="server" text="Configuration" section="tblConfiguration"
							resourcekey="Configuration" />
						<table id="tblConfiguration" cellspacing="2" cellpadding="2" summary="Configuration Design Table"
							border="0" runat="server">
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plVersion" text="SharpContent Version:" controlname="lblVersion" runat="server" /></td>
								<td><asp:Label ID="lblVersion" Runat="server" CssClass="NormalBold"></asp:Label></td>
							</tr>
							<tr visible="false">
								<td class="SubHead" style="width: 150;"><scp:label id="plUpgrade" text="Check For Upgrades?" controlname="chkUpgrade" runat="server" /></td>
								<td>
                            ...
                            <tr visible="false">
                                <td class="SubHead" style="width: 150;">
                                    <scp:Label ID="plAvailable" runat="server" ControlName="hypUpgrade" Text="Upgrade Available?" />
                                </td>
                                <td>
                                    <asp:HyperLink ID="hypUpgrade" runat="server" Target="_new"></asp:HyperLink></td>
                            </tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plDataProvider" text="Data Provider:" controlname="lblDataProvider" runat="server" /></td>
								<td><asp:Label ID="lblDataProvider" Runat="server" CssClass="NormalBold"></asp:Label></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plFramework" text=".NET Framework:" controlname="lblFramework" runat="server" /></td>
								<td><asp:Label ID="lblFramework" Runat="server" CssClass="NormalBold"></asp:Label></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plIdentity" text="ASP.NET Identity:" controlname="lblIdentity" runat="server" /></td>
								<td><asp:Label ID="lblIdentity" Runat="server" CssClass="NormalBold"></asp:Label></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plHostName" text="Host Name:" controlname="lblHostName" runat="server" /></td>
								<td><asp:Label ID="lblHostName" Runat="server" CssClass="NormalBold"></asp:Label></td>
							</tr>
						</table>
						<br/>
						<scp:sectionhead id="dshHost" cssclass="Head" runat="server" text="Host Details" section="tblHost"
							resourcekey="HostDetails" />
						<table id="tblHost" cellspacing="2" cellpadding="2" summary="Site Details Design Table"
							border="0" runat="server">
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plHostPortal" text="Host Portal:" controlname="cboHostPortal" runat="server" /></td>
							...
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plHostTitle" text="Host Title:" controlname="txtHostTitle" runat="server" /></td>
								<td><asp:textbox id="txtHostTitle" cssclass="NormalTextBox" runat="server" maxlength="256" width="300"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plHostURL" text="Host URL:" controlname="txtHostURL" runat="server" /></td>
								<td><asp:textbox id="txtHostURL" cssclass="NormalTextBox" runat="server" maxlength="256" width="300"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plHostEmail" text="Host Email:" controlname="txtHostEmail" runat="server" /></td>
								<td><asp:textbox id="txtHostEmail" cssclass="NormalTextBox" runat="server" maxlength="256" width="300"></asp:textbox></td>
							</tr>
						</table>
						<br/>
						<scp:sectionhead id="dshAppearance" cssclass="Head" runat="server" text="Appearance" section="tblAppearance"
							resourcekey="Appearance" />
						<table id="tblAppearance" cellspacing="2" cellpadding="2" summary="Appearance Design Table"
							border="0" runat="server">
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plCopyright" text="Show Copyright Credits?" controlname="chkCopyright" runat="server" /></td>
								<td valign="top"><asp:checkbox id="chkCopyright" cssclass="NormalTextBox" runat="server"></asp:checkbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plUseCustomErrorMessages" text="Use Custom Error Messages?" controlname="chkUseCustomErrorMessages"
										runat="server" /></td>
								<td valign="top"><asp:checkbox id="chkUseCustomErrorMessages" cssclass="NormalTextBox" runat="server"></asp:checkbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plHostSkin" text="Host Skin:" controlname="ctlHostSkin" runat="server" /></td>
								<td valign="top"><portal:skin id="ctlHostSkin" runat="server"></portal:skin></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plHostContainer" text="Host Container:" controlname="ctlHostContainer" runat="server" /></td>
								<td valign="top"><portal:skin id="ctlHostContainer" runat="server"></portal:skin></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plAdminSkin" text="Admin Skin:" controlname="ctlAdminSkin" runat="server" /></td>
								<td valign="top"><portal:skin id="ctlAdminSkin" runat="server"></portal:skin></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plAdminContainer" text="Admin Container:" controlname="txtHostEmail" runat="server" /></td>
                  ...
                  Container</asp:HyperLink></td>
						...
						<br/>
						<scp:sectionhead id="dshPayment" cssclass="Head" runat="server" text="Payment Settings" isExpanded="False"
							section="tblPayment" resourcekey="Payment" />
						<table id="tblPayment" cellspacing="2" cellpadding="2" summary="Appearance Design Table"
							border="0" runat="server">
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plProcessor" text="Payment Processor:" controlname="cboProcessor" runat="server" /></td>
								<td align="left">
							...
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plUserId" text="Payment UserId:" controlname="txtUserId" runat="server" /></td>
								<td><asp:textbox id="txtUserId" runat="server" width="300" maxlength="50" cssclass="NormalTextBox"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plPassword" text="Payment Password:" controlname="txtPassword" runat="server" /></td>
								<td><asp:textbox id="txtPassword" runat="server" width="300" maxlength="50" cssclass="NormalTextBox"
										textmode="Password"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plHostFee" text="Hosting Fee:" controlname="txtHostFee" runat="server" /></td>
								<td><asp:textbox id="txtHostFee" cssclass="NormalTextBox" runat="server" maxlength="10" width="300"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plHostCurrency" text="Hosting Currency:" controlname="cboHostCurrency" runat="server" /></td>
                            ...
                            <tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plHostSpace" text="Hosting Space (MB):" controlname="txtHostSpace" runat="server" /></td>
								<td><asp:textbox id="txtHostSpace" cssclass="NormalTextBox" runat="server" maxlength="6" width="100"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plPageQuota" text="Page Quota:" controlname="txtPageQuota" runat="server" /></td>
								<td><asp:textbox id="txtPageQuota" cssclass="NormalTextBox" runat="server" maxlength="6" width="100"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plUserQuota" text="User Quota:" controlname="txtUserQuota" runat="server" /></td>
								<td><asp:textbox id="txtUserQuota" cssclass="NormalTextBox" runat="server" maxlength="6" width="100"></asp:textbox></td>
							</tr>							
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plDemoPeriod" text="Demo Period (Days):" controlname="txtDemoPeriod" runat="server" /></td>
								<td><asp:textbox id="txtDemoPeriod" cssclass="NormalTextBox" runat="server" maxlength="3" width="300"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plDemoSignup" text="Anonymous Demo Signup:" controlname="chkDemoSignup" runat="server" /></td>
			...
			<br/>
			<scp:sectionhead id="dshAdvanced" runat="server" cssclass="Head" text="Advanced Settings" section="tblAdvanced"
			...
			<table id="tblAdvanced" cellspacing="0" cellpadding="2" width="525" summary="Basic Settings Design Table"
				...
				<tr>
					<td style="width: 25;"></td>
					<td valign="top" style="width: 475;">
						<scp:sectionhead id="dshFriendlyUrl" cssclass="Head" runat="server" text="Friendly Url Settings" isexpanded="False"
                        ...
                        <table id="tblFriendlyUrl" runat="server" cellspacing="2" cellpadding="2" summary="Appearance Design Table" border="0">
	                        <tr>
		                        <td class="SubHead" style="width: 150;"><scp:label id="plUseFriendlyUrls" text="Use Friendly Urls?" controlname="chkUseFriendlyUrls" runat="server" /></td>
	                        ...
	                        <tr id="rowFriendlyUrls" runat="server">
	                            <td colspan="2" align="center">
						            <scp:FriendlyUrls id="friendlyUrls" runat="server" />
	                            </td>
	                        </tr>
	                    </table>
						<br>
						<scp:sectionhead id="dshProxy" cssclass="Head" runat="server" text="Proxy Settings" isexpanded="False"
							section="tblProxy" resourcekey="Proxy" />
						<table id="tblProxy" cellspacing="2" cellpadding="2" summary="Appearance Design Table"
							border="0" runat="server">
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plProxyServer" text="Proxy Server:" controlname="txtProxyServer" runat="server" /></td>
								<td><asp:textbox id="txtProxyServer" cssclass="NormalTextBox" runat="server" maxlength="256" width="300"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plProxyPort" text="Proxy Port:" controlname="txtProxyPort" runat="server" /></td>
								<td><asp:textbox id="txtProxyPort" cssclass="NormalTextBox" runat="server" maxlength="256" width="300"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plProxyUsername" text="Proxy Username:" controlname="txtProxyUsername" runat="server" /></td>
								<td><asp:textbox id="txtProxyUsername" cssclass="NormalTextBox" runat="server" maxlength="256" width="300"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plProxyPassword" text="Proxy Password:" controlname="txtProxyPassword" runat="server" /></td>
								<td><asp:textbox id="txtProxyPassword" cssclass="NormalTextBox" runat="server" maxlength="256" width="300"
										textmode="Password"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plWebRequestTimeout" text="Web Request Timeout:" controlname="txtWebRequestTimeout"
										runat="server" /></td>
						...
						<br/>
						<scp:sectionhead id="dshSMTP" cssclass="Head" runat="server" text="SMTP Server Settings" isexpanded="False"
							section="tblSMTP" resourcekey="SMTP" />
						<table id="tblSMTP" cellspacing="2" cellpadding="2" summary="Appearance Design Table" border="0"
							runat="server">
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plSMTPServer" text="SMTP Server:" controlname="txtSMTPServer" runat="server" /></td>
								<td align="left">
							...
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plSMTPAuthentication" text="SMTP Authentication:" controlname="optSMTPAuthentication"
										runat="server" /></td>
								<td>
							...
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plSMTPEnableSSL" text="SMTP Enable SSL:" controlname="chkSMTPEnableSSL" runat="server" /></td>
								<td>
        							<asp:CheckBox ID="chkSMTPEnableSSL" runat="server" />&nbsp;
                                </td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plSMTPUsername" text="SMTP Username:" controlname="txtSMTPUsername" runat="server" /></td>
								<td><asp:textbox id="txtSMTPUsername" cssclass="NormalTextBox" runat="server" maxlength="256" width="300"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plSMTPPassword" text="SMTP Password:" controlname="txtSMTPPassword" runat="server" /></td>
								<td><asp:textbox id="txtSMTPPassword" cssclass="NormalTextBox" runat="server" maxlength="256" width="300"
										textmode="Password"></asp:textbox></td>
							</tr>
						</table>
						<br/>
						<scp:sectionhead id="dshPerformance" cssclass="Head" runat="server" text="Performance Settings" isexpanded="False"
						...
						<table id="tblPerformance" cellspacing="2" cellpadding="2" summary="Performance Design Table"
							border="0" runat="server">
							<tr>
								<td class="SubHead" style="width: 200;" valign="top"><scp:label id="plPageState" runat="server" controlname="cboPageState" text="Page State Persistence:"></scp:label></td>
								<td>
							...
							<tr>
								<td class="SubHead" style="width: 200;" valign="top"><scp:label id="plCacheMethod" runat="server" controlname="cboCacheMethod" text="Cache Method:"></scp:label></td>
								<td>
							...
							<tr>
								<td class="SubHead" style="width: 200;"><scp:label id="plPerformance" text="Performance Setting:" controlname="cboPerformance" runat="server" /></td>
								<td>
							...
							<tr>
								<td class="SubHead" style="width: 200;"><scp:label id="plCacheability" text="Authenticated Cacheability:" controlname="cboCacheability" runat="server" /></td>
								<td>
							...
							<tr>
								<td class="SubHead" style="width: 200;"><scp:label id="plCompression" text="Compression Setting:" controlname="cboCompression" runat="server" /></td>
								<td>
							...
							<tr>
								<td class="SubHead" style="width: 200;"><scp:label id="plCompressionLevel" text="Compression Level:" controlname="cboLevel" runat="server" /></td>
								<td>
							...
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plWhitespace" text="Use Whitespace Filter:" controlname="chkWhitespace" runat="server" /></td>
								<td>
						...
						<br/>
                        <scp:sectionhead id="dshCompression" cssclass="Head" runat="server" text="Compression Settings" isexpanded="False"
						...
						<table id="tblCompression" cellspacing="2" cellpadding="2" summary="Compression Design Table"
							border="0" runat="server">
							<tr>
								<td class="SubHead" style="width: 200;" valign="top"><scp:label id="plExcludedMimeTypes" runat="server" controlname="txtExcludedMimeTypes" text="Excluded Mime Types:"></scp:label></td>
							...
							<tr>
								<td class="SubHead" style="width: 200;" valign="top"><scp:label id="plExcludedPaths" runat="server" controlname="txtExcludedPaths" text="Excluded Paths:"></scp:label></td>
							...
							<tr>
								<td class="SubHead" style="width: 200;" valign="top"><scp:label id="plWhitespaceFilter" runat="server" controlname="txtWhitespaceFilter" text="Whitespace Filter:"></scp:label></td>
						...
						<scp:sectionhead id="dshOther" cssclass="Head" runat="server" text="Other Settings" isexpanded="False"
							section="tblOther" resourcekey="Other" />
						<table id="tblOther" cellspacing="2" cellpadding="2" summary="Appearance Design Table"
							border="0" runat="server">
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plControlPanel" text="Control Panel:" controlname="cboControlPanel" runat="server" /></td>
								<td valign="top"><asp:dropdownlist id="cboControlPanel" cssclass="NormalTextBox" width="300" runat="server"></asp:dropdownlist></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plSiteLogStorage" text="Site Log Storage:" controlname="optSiteLogStorage" runat="server" /></td>
								<td>
							...
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plSiteLogBuffer" text="Site Log Buffer (Items):" controlname="txtSiteLogBuffer"
										runat="server" /></td>
								<td><asp:textbox id="txtSiteLogBuffer" cssclass="NormalTextBox" runat="server" maxlength="4" width="300"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plSiteLogHistory" text="Site Log History (Days):" controlname="txtSiteLogHistory"
										runat="server" /></td>
								<td><asp:textbox id="txtSiteLogHistory" cssclass="NormalTextBox" runat="server" maxlength="3" width="300"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plUsersOnline" text="Disable Users Online?" controlname="chkUsersOnline" runat="server" /></td>
								<td><asp:checkbox id="chkUsersOnline" cssclass="NormalTextBox" runat="server"></asp:checkbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plUsersOnlineTime" text="Users Online Time (Minutes):" controlname="txtUsersOnlineTime"
										runat="server" /></td>
								<td><asp:textbox id="txtUsersOnlineTime" cssclass="NormalTextBox" runat="server" maxlength="3" width="300"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plAutoAccountUnlock" text="Auto-Unlock Accounts After (Minutes):" controlname="txtAutoAccountUnlock"
										runat="server" /></td>
								<td><asp:textbox id="txtAutoAccountUnlock" cssclass="NormalTextBox" runat="server" maxlength="3"
										width="300"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plAutoExpirePassword" text="Auto-Expire Password After (Days):" controlname="txtAutoExpirePassword"
										runat="server" /></td>
								<td><asp:textbox id="txtAutoExpirePassword" cssclass="NormalTextBox" runat="server" maxlength="3"
										width="300"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plFileExtensions" text="File Upload Extensions:" controlname="txtFileExtensions"
										runat="server" /></td>
							...
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plSkinUpload" text="Skin Upload Permission:" controlname="optSkinUpload" runat="server" /></td>
								<td>
							...
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plSchedulerMode" text="Scheduler Mode:" controlname="cboSchedulerMode" runat="server" /></td>
								<td>
							...
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plLogBuffer" text="Enable Event Log Buffer?" controlname="chkUsersOnline" runat="server" /></td>
								<td><asp:checkbox id="chkLogBuffer" cssclass="NormalTextBox" runat="server"></asp:checkbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plHelpUrl" text="Help Url:" controlname="txtHelpURL" runat="server" /></td>
								<td><asp:textbox id="txtHelpURL" cssclass="NormalTextBox" runat="server" maxlength="256" width="300"></asp:textbox></td>
							</tr>
							<tr>
								<td class="SubHead" style="width: 150;"><scp:label id="plEnableHelp" text="Enable Module Help?" controlname="chkEnableHelp" runat="server" /></td>
								<td valign="top"><asp:checkbox id="chkEnableHelp" cssclass="NormalTextBox" runat="server"></asp:checkbox></td>
							</tr>
							<tr>
                                <td class="SubHead" style="width: 150;">
                                    <scp:Label ID="plAutoSync" runat="server" ControlName="chkAutoSync" Text="Enable File System Auto-Sync?" />
                                </td>
                                <td valign="top">
...
<table class="Settings" cellspacing="2" cellpadding="2" summary="Host Settings Design Table" border="0">
	<tr>
        <td class="SubHead" valign="bottom">
            <scp:Label ID="plLog" runat="server" ControlName="cboUpgrade" Text="View Upgrade Log For Version:" />
        </td>
        <td valign="bottom">			
