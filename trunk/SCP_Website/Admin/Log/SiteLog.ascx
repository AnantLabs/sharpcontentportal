...
<%@ Control Inherits="SharpContent.Modules.Admin.SiteLog.SiteLog" Language="C#" AutoEventWireup="true"  CodeFile="SiteLog.ascx.cs" %>
<table class="Settings" cellspacing="2" cellpadding="2" summary="Site Log Design Table" border="0" width="450">
	<tr vAlign="top">
    <td class="SubHead" width="150"><scp:label id="plReportType" runat="server" controlname="cboReportType" suffix=":"></scp:label></td>
	...
	<tr>
    <td class="SubHead" width="150"><scp:label id="plStartDate" runat="server" controlname="txtStartDate" suffix=":"></scp:label></td>
		<td class="NormalBold" align="left" width="325">
	...
	<tr>
    <td class="SubHead" width="150"><scp:label id="plEndDate" runat="server" controlname="txtEndDate" suffix=":"></scp:label></td>
		<td class="NormalBold" align="left" width="325">
