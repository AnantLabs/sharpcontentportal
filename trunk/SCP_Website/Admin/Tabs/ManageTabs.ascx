...
<%@ Register Src="~/controls/URLControl.ascx" TagName="URL" TagPrefix="scp" %>
<%@ Register Assembly="SharpContent" Namespace="SharpContent.Security.Permissions.Controls" TagPrefix="Portal" %>
<%@ Register Src="~/controls/SkinControl.ascx" TagName="Skin" TagPrefix="scp" %>
<%@ Control AutoEventWireup="true" CodeFile="ManageTabs.ascx.cs"  Inherits="SharpContent.Modules.Admin.Tabs.ManageTabs" Language="C#" %>
    ...
    <tr>
        <td valign="top" style="width: 560;">
            <asp:Panel ID="pnlSettings" runat="server" CssClass="WorkPanel" Visible="True">
                ...
                <table id="tblBasic" runat="server" border="0" cellpadding="2" cellspacing="0" summary="Basic Settings Design Table" width="525">
                    ...
                    <tr>
                        ...
                        <td valign="top" style="width: 475;">
                            <scp:SectionHead ID="dshPage" runat="server" CssClass="Head" ResourceKey="PageDetails" Section="tblPage" Text="Page Details" />
                            <table id="tblPage" runat="server" border="0" cellpadding="2" cellspacing="2" summary="Site Details Design Table">
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plTabName" runat="server" ControlName="txtTabName" HelpKey="TabNameHelp" ResourceKey="TabName" Suffix=":" />
                                    </td>
                                    <td style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plTitle" runat="server" ControlName="txtTitle" HelpKey="TitleHelp" ResourceKey="Title" Suffix=":" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plDescription" runat="server" ControlName="txtDescription" HelpKey="DescriptionHelp" ResourceKey="Description" Suffix=":" />
                                    </td>
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plKeywords" runat="server" ControlName="txtKeyWords" HelpKey="KeyWordsHelp" ResourceKey="KeyWords" Suffix=":" />
                                    </td>
                                    <td class="NormalTextBox" style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plParentTab" runat="server" ControlName="cboTab" HelpKey="ParentTabHelp" ResourceKey="ParentTab" Suffix=":" />
                                    </td>
                                    <td style="width: 325;">
                                ...
                                <tr id="rowTemplate" runat="server">
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plTemplate" runat="server" ControlName="cboTemplate" HelpKey="TemplateHelp" ResourceKey="Template" Suffix=":" />
                                    </td>
                                    <td style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <br/>
                                        <br/>
                                        <scp:Label ID="plPermissions" runat="server" ControlName="dgPermissions" HelpKey="PermissionsHelp" ResourceKey="Permissions" Suffix=":" />
                                    </td>
                                    <td style="width: 325;">
                                ...
                                <tr id="rowCopyPerm" runat="server">
                                    <td class="SubHead">
                                        <scp:Label ID="plCopyPerm" runat="server" ResourceKey="plCopyPerm" />
                                    </td>
                                    <td>
                ...
                <br/>
                <scp:SectionHead ID="dshCopy" runat="server" CssClass="Head" IncludeRule="True" ResourceKey="Copy" Section="tblCopy" Text="Copy Page" />
                <table id="tblCopy" runat="server" border="0" cellpadding="2" cellspacing="0" summary="Copy Tab Design Table" width="525">
                    <tr>
                        <td style="width: 25;">
                        </td>
                        <td class="SubHead" style="width: 150;">
                            <scp:Label ID="plCopyPage" runat="server" ControlName="cboCopyPage" HelpKey="CopyModulesHelp" ResourceKey="CopyModules" Suffix=":" />
                        </td>
                        <td style="width: 325;">
                    ...
                    <tr id="rowModules" runat="server">
                        ...
                        <td class="SubHead" colspan="2">
                            <scp:Label ID="plModules" runat="server" ControlName="grdModules" HelpKey="CopyContentHelp" ResourceKey="CopyContent" Suffix=":" />
                            <br/>
                ...
                <table id="tblAdvanced" runat="server" border="0" cellpadding="2" cellspacing="0" summary="Advanced Settings Design Table" width="525">
                    ...
                    <tr>
                        ...
                        <td valign="top" style="width: 475;">
                            <scp:SectionHead ID="dhsAppearance" runat="server" CssClass="Head" ResourceKey="Appearance" Section="tblAppearance" Text="Appearance" />
                            <table id="tblAppearance" runat="server" border="0" cellpadding="2" cellspacing="2" summary="Appearance Design Table">
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <scp:Label ID="plIcon" runat="server" ControlName="ctlIcon" HelpKey="IconHelp" ResourceKey="Icon" Suffix=":" />
                                    </td>
                                    <td style="width: 325;">
                                        <scp:URL ID="ctlIcon" runat="server" ShowLog="False" Width="300" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <scp:Label ID="plSkin" runat="server" ControlName="ctlSkin" HelpKey="TabSkinHelp" ResourceKey="TabSkin" Suffix=":" />
                                    </td>
                                    <td valign="top" style="width: 325;">
                                        <scp:Skin ID="ctlSkin" runat="server" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <scp:Label ID="plContainer" runat="server" ControlName="ctlContainer" HelpKey="TabContainerHelp" ResourceKey="TabContainer" Suffix=":" />
                                    </td>
                                    <td valign="top" style="width: 325;">
                                        <scp:Skin ID="ctlContainer" runat="server" />
                                    </td>
                                </tr>
                                <tr id="rowCopySkin" runat="server">
                                    <td class="SubHead">
                                        <scp:Label ID="plCopySkin" runat="server" ResourceKey="plCopySkin" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <scp:Label ID="plHidden" runat="server" ControlName="chkHidden" HelpKey="HiddenHelp" ResourceKey="Hidden" Suffix=":" />
                                    </td>
                                    <td style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <scp:Label ID="plDisable" runat="server" ControlName="chkDisableLink" HelpKey="DisabledHelp" ResourceKey="Disabled" Suffix=":" />
                                    </td>
                                    <td style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plRefreshInterval" runat="server" ControlName="cboRefreshInterval" HelpKey="RefreshInterval.Help" ResourceKey="RefreshInterval" Suffix=":" />
                                    </td>
                                    <td style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <scp:Label ID="plPageHeadText" runat="server" ControlName="txtPageHeadText" HelpKey="PageHeadText.Help" ResourceKey="PageHeadText" Suffix=":" />
                                    </td>
                                    <td class="NormalTextBox" style="width: 325;">
                            ...
                            <br/>
                            <scp:SectionHead ID="dshOther" runat="server" CssClass="Head" ResourceKey="OtherSettings" Section="tblOther" Text="Other Settings" />
                            <table id="tblOther" runat="server" border="0" cellpadding="2" cellspacing="2" summary="Appearance Design Table">
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <scp:Label ID="plStartDate" runat="server" ControlName="txtStartDate" Text="Start Date:" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="SubHead" valign="top" width="150">
                                        <scp:Label ID="plEndDate" runat="server" ControlName="txtEndDate" Text="End Date:" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <scp:Label ID="plURL" runat="server" ControlName="ctlURL" HelpKey="UrlHelp" ResourceKey="Url" Suffix=":" />
                                    </td>
                                    <td class="NormalTextBox" style="width: 325;">
                                        <scp:URL ID="ctlURL" runat="server" ShowLog="False" ShowNone="True" ShowTrack="False" Width="300" />
                                    </td>
                                </tr>
                            </table>
                        </td>
