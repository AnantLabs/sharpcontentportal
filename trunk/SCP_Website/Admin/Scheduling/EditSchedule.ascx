<%@ Control AutoEventWireup="true" CodeFile="EditSchedule.ascx.cs"  Inherits="SharpContent.Modules.Admin.Scheduling.EditSchedule" Language="C#" %>
    ...
    <table border="0" cellpadding="3" cellspacing="0" summary="Edit Schedule" width="750">
        <tr valign="top">
            <td class="SubHead" width="150">
                <scp:Label ID="plType" runat="server" ControlName="txtType" Text="Full Class Name and Assembly:" />
            </td>
            <td class="Normal">
        ...
        <tr valign="top">
            <td class="SubHead" width="150">
                <scp:Label ID="plEnabled" runat="server" ControlName="chkEnabled" Text="Schedule Enabled:" />
            </td>
            <td class="Normal">
        ...
        <tr valign="top">
            <td class="SubHead" width="150">
                <scp:Label ID="plTimeLapse" runat="server" ControlName="txtTimeLapse" Text="Time Lapse:" />
            </td>
            <td class="Normal">
        ...
        <tr valign="top">
            <td class="SubHead" width="150">
                <scp:Label ID="plRetryTimeLapse" runat="server" ControlName="txtRetryTimeLapse" Text="Retry Frequency:" />
            </td>
            <td class="Normal">
        ...
        <tr valign="top">
            <td class="SubHead" width="150">
                <scp:Label ID="plRetainHistoryNum" runat="server" ControlName="ddlRetainHistoryNum" Text="Retain Schedule History:" />
            </td>
            <td class="Normal">
        ...
        <tr valign="top">
            <td class="SubHead" width="150">
                <scp:Label ID="plAttachToEvent" runat="server" ControlName="ddlAttachToEvent" Text="Run on Event:" />
            </td>
            <td class="Normal">
        ...
        <tr valign="top">
            <td class="SubHead" width="150">
                <scp:Label ID="plCatchUpEnabled" runat="server" ControlName="chkCatchUpEnabled" Text="Catch Up Enabled:" />
            </td>
            <td class="Normal">
        ...
        <tr valign="top">
            <td class="SubHead" width="150">
                <scp:Label ID="plObjectDependencies" runat="server" ControlName="txtObjectDependencies" Text="Object Dependencies:" />
            </td>
            <td class="Normal">
        ...
        <tr valign="top">
            <td class="SubHead" width="150">
                <scp:Label ID="plServers" runat="server" ControlName="txtServers" Text="Run on Servers:" />
            </td>
            <td class="Normal">
