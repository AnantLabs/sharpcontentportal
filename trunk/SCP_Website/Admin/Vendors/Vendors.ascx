<%@ Control Language="C#" AutoEventWireup="true" Inherits="SharpContent.Modules.Admin.Vendors.Vendors" CodeFile="Vendors.ascx.cs" %>
<%@ Register TagPrefix="SCPsc" Namespace="SharpContent.UI.WebControls" Assembly="SharpContent" %>
...
<br/>
<br/>
<SCPsc:PagingControl id="ctlPagingControl" runat="server"></SCPsc:PagingControl>
<p align="center">
