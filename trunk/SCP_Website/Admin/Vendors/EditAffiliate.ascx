...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="SharpContent.Modules.Admin.Vendors.EditAffiliate" CodeFile="EditAffiliate.ascx.cs" %>
<table cellspacing="2" cellpadding="0" width="560">
    ...
    <tr>
        <td class="SubHead" width="200">
            <scp:label id="plCPC" runat="server" controlname="txtCPC" suffix=":">
            </scp:label></td>
        <td width="325">
    ...
    <tr>
        <td class="SubHead" width="200">
            <scp:label id="plCPA" runat="server" controlname="txtCPA" suffix=":">
            </scp:label></td>
        <td width="325">
