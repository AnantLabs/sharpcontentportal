...
namespace SharpContent.UI.WebControls
{
	...
	public abstract class XmlCollectionBase : ICollection, IList, IEnumerable
	{
		...
		public XmlCollectionBase(string strXML, string strXSLFile)
		{
			...
			//m_objNode = New SCPNode(InnerXMLNode)
		}
		...
		private SharpContent.UI.WebControls.SCPTree m_objTree;
		...
		//Yes, this is a hack!
		protected XmlCollectionBase(SharpContent.UI.WebControls.SCPTree objTreeControl)
		{
			m_objTree = objTreeControl;
		}

		public XmlCollectionBase(XmlNode objXmlNode, SharpContent.UI.WebControls.SCPTree objTreeControl)
		{
			m_objTree = objTreeControl;
			InnerXMLNode = objXmlNode;
			InnerXMLDoc = InnerXMLNode.OwnerDocument;
		...
		public XmlCollectionBase(string strNamespace, SharpContent.UI.WebControls.SCPTree objTreeControl)
		{
			m_objTree = objTreeControl;
			InnerXMLDoc = new System.Xml.XmlDocument();
			InnerXMLNode = InnerXMLDoc.CreateNode(XmlNodeType.Element, "root", "");
