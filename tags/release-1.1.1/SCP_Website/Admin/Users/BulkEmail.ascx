<%@ Register Src="~/controls/TextEditor.ascx" TagName="TextEditor" TagPrefix="scp" %>
...
<%@ Control AutoEventWireup="true" CodeFile="BulkEmail.ascx.cs"  Inherits="SharpContent.Modules.Admin.Users.BulkEmail" Language="C#" %>
<%@ Register Src="~/controls/URLControl.ascx" TagName="URLControl" TagPrefix="scp" %>
    ...
    <tr>
        <td valign="top" width="560">
            <asp:Panel ID="pnlSettings" runat="server" CssClass="WorkPanel" Visible="True">
                ...
                <table id="tblBasic" runat="server" border="0" cellpadding="2" cellspacing="0" summary="Basic Settings Design Table" width="525">
                    ...
                    <tr>
                        <td class="SubHead" width="150">
                            <scp:Label ID="plRoles" runat="server" ControlName="chkRoles" Suffix=":" />
                        </td>
                    ...
                    <tr valign="top">
                        <td class="SubHead" width="150">
                            <scp:Label ID="plEmail" runat="server" ControlName="txtEmail" Suffix=":" />
                        </td>
                        <td align="center" width="325">
                    ...
                    <tr valign="top">
                        <td class="SubHead" width="150">
                            <scp:Label ID="plFrom" runat="server" ControlName="txtFrom" Suffix=":" />
                        </td>
                        <td width="325">
                    ...
                    <tr valign="top">
                        <td class="SubHead" width="150">
                            <scp:Label ID="plSubject" runat="server" ControlName="txtSubject" Suffix=":" />
                        </td>
                        <td width="325">
                ...
                <br>
                <scp:SectionHead ID="dshMessage" runat="server" CssClass="Head" IncludeRule="True" ResourceKey="Message" Section="tblMessage" Text="Message" />
                <table id="tblMessage" runat="server" border="0" cellpadding="2" cellspacing="0" summary="Message Design Table" width="525">
                    ...
                    <tr valign="top">
                        <td colspan="2">
                            <scp:TextEditor ID="teMessage" runat="server" ChooseMode="True" ChooseRender="False" DefaultMode="Rich" Height="350" HtmlEncode="False" TextRenderMode="Raw" Width="550" />
                        </td>
                    </tr>
                </table>
                <br>
                ...
                <table id="tblAdvanced" runat="server" border="0" cellpadding="2" cellspacing="0" summary="Message Design Table" width="525">
                    ...
                    <tr valign="top">
                        <td class="SubHead" width="150">
                            <scp:Label ID="plAttachment" runat="server" ControlName="cboAttachment" Suffix=":" />
                        </td>
                        <td width="325">
                            <scp:URLControl ID="ctlAttachment" runat="server" Required="False" ShowLog="False" ShowTabs="False" ShowTrack="False" ShowUpLoad="true" ShowUrls="False" />
                        </td>
                    </tr>
                    <tr valign="top">
                        <td class="SubHead" width="150">
                            <scp:Label ID="plPriority" runat="server" ControlName="cboPriority" Suffix=":" />
                        </td>
                        <td width="325">
                    ...
                    <tr valign="top">
                        <td class="SubHead" width="150">
                            <scp:Label ID="plSendMethod" runat="server" ControlName="cboSendMethod" Suffix=":" />
                        </td>
                        <td width="325">
                    ...
                    <tr valign="top">
                        <td class="SubHead" width="150">
                            <scp:Label ID="plSendAction" runat="server" ControlName="optSendAction" Suffix=":" />
                        </td>
                        <td width="325">
