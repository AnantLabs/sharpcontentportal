<%@ Control Language="C#" AutoEventWireup="true" Inherits="SharpContent.Services.Wizards.WizardSuccess" TargetSchema="http://schemas.microsoft.com/intellisense/ie3-2nav3-0" %>
