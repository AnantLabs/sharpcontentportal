...
<%@ Control AutoEventWireup="true" CodeFile="EditSkins.ascx.cs" Inherits="SharpContent.Modules.Admin.Skins.EditSkins" Language="C#" %>
<center>
    <table border="0" cellpadding="0" cellspacing="0" width="500">
        ...
        <tr id="typeRow" runat="server">
            <td align="right" class="SubHead" colspan="2" valign="middle">
                <scp:Label ID="plType" runat="server" Text="Skin Type:" />
            </td>
        ...
        <tr>
            <td class="SubHead" valign="middle">
                <scp:Label ID="plSkins" runat="server" ControlName="cboSkins" Suffix=":" />
            </td>
            <td>
                <asp:DropDownList ID="cboSkins" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cboSkins_SelectedIndexChanged">
                </asp:DropDownList></td>
            <td class="SubHead" valign="middle">
                <scp:Label ID="plContainers" runat="server" ControlName="cboContainers" Suffix=":" />
            </td>
            <td>
