<%@ Import namespace="SharpContent.Common"%>
<%@ Control Language="C#" AutoEventWireup="true"  Inherits="SharpContent.Modules.Admin.Portals.PortalAlias" CodeFile="PortalAlias.ascx.cs" %>
