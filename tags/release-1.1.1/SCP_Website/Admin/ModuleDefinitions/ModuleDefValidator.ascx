<%@ Control Language="C#" AutoEventWireup="true"  Inherits="SharpContent.Modules.Admin.ModuleDefinitions.ModuleDefValidator" CodeFile="ModuleDefValidator.ascx.cs" %>
<%@ Register TagPrefix="scp" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<br/>
<div align="center">
    <div>
        <asp:label id="lblBrowse" resourcekey="lblBrowse" cssClass="Normal" runat="server">Please select a *.scp file from your local system for validation.</asp:label>
        <br/>
