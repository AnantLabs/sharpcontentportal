<%@ Control AutoEventWireup="true" CodeFile="LanguageEditor.ascx.cs" Inherits="SharpContent.Services.Localization.LanguageEditor" Language="C#" %>
...
<%@ Register Assembly="SharpContent.WebControls" Namespace="SharpContent.UI.WebControls" TagPrefix="SCPtv" %>
        ...
        <td nowrap="nowrap" valign="top">
            <p>
                <asp:Panel ID="Panel1" runat="server" Width="195px">
                    <SCPtv:SCPTree ID="SCPTree" runat="server" CssClass="Normal" DefaultNodeCssClass="Normal" DefaultNodeCssClassOver="Normal">
                    </SCPtv:SCPTree>
                </asp:Panel>
            </p>
        </td>
            ...
            <table id="Table1" border="0" cellpadding="1" cellspacing="1">
                    ...
                    <tr>
                        <td class="SubHead" style="width: 150;" valign="top">
                            <scp:Label ID="lbLocales" runat="server" ControlName="cboLocales" Text="Available Locales" />
                        </td>
                        <td valign="top">
                    ...
                    <tr id="rowMode" runat="server">
                        <td class="SubHead" style="width: 150;" valign="top">
                            <scp:Label ID="lbMode" runat="server" ControlName="cboLocales" Text="Available Locales" />
                        </td>
                        <td valign="top">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 100%;">
                                            <table border="0">
                                                <tr>
                                                    <td>
                                                        <scp:SectionHead ID="dshDef" runat="server" CssClass="Normal" IncludeRule="False" IsExpanded='<%# ExpandDefault((Pair)DataBinder.Eval(Container, "DataItem.value"))  %>' Section="divDef" Text="" />
                                                    </td>
                                                    <td>
