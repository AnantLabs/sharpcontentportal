...
<%@ Control Language="C#" Inherits="SharpContent.Modules.Admin.Security.SendPassword" CodeFile="SendPassword.ascx.cs" AutoEventWireup="true"  %>
<table cellspacing="0" cellpadding="3" border="0" summary="SignIn Design Table" width="160">
	<tr>
		<td width="160" class="SubHead"><scp:label id="plAccountNumber" controlname="txtAccountNumber" runat="server" text="AccountNumber:"></scp:label></td>
	</tr>
	<tr>
		<td width="160"><asp:textbox id="txtAccountNumber" columns="9" width="130" cssclass="NormalTextBox" runat="server" /></td>
	</tr>
	<tr>
	...
	<tr id="trCaptcha2" runat="server">
		<td colspan="2" style="height: 115px"><scp:captchacontrol id="ctlCaptcha" captchawidth="130" captchaheight="40" cssclass="Normal" runat="server" errorstyle-cssclass="NormalRed" /></td>
	</tr>
	<tr>
		<td>
	...
	<tr>
		<td><scp:commandbutton id="cmdSendPassword" imageurl="~/images/password.gif" resourcekey="cmdSendPassword" cssclass="CommandButton" runat="server"/></td>
	</tr>
	<tr>
