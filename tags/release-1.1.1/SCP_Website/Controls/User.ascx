<%@ Control Language="C#" AutoEventWireup="true"  Inherits="SharpContent.UI.UserControls.User" %>
<%@ Register TagPrefix="wc" Namespace="SharpContent.UI.WebControls" Assembly="SharpContent.CountryListBox" %>
...
<table cellSpacing="0" cellPadding="1" border="0" summary="User Design Table">
	<tr>
		<td class="SubHead" width="175">
			<scp:label id="plFirstName" runat="server" controlname="txtFirstName" text="First Name:"></scp:label></td>
	...
	<tr>
		<td class="SubHead" width="175">
			<scp:label id="plLastName" runat="server" controlname="txtLastName" text="Last Name:"></scp:label></td>
		<td class="NormalBold" noWrap>
	...
	<tr>
		<td class="SubHead" width="175">
			<scp:label id="plAccountNumber" runat="server" controlname="txtAccountNumber" text="Account Number:"></scp:label></td>
		<td class="NormalBold" noWrap>
			<asp:textbox id="txtAccountNumber" tabIndex="3" runat="server" cssclass="NormalTextBox" size="25"
				maxlength="175"></asp:textbox>
			<asp:label id="lblAccountNumberAsterisk" runat="server">*</asp:label>
			<asp:label id="lblAccountNumber" runat="server"></asp:label>
			<asp:requiredfieldvalidator id="valAccountNumber" runat="server" cssclass="NormalRed" display="Dynamic" errormessage="<br>Account Number Is Required."
				controltovalidate="txtAccountNumber" resourcekey="valAccountNumber"></asp:requiredfieldvalidator></td>
	</tr>
	<tr>
		<td class="SubHead" width="175">
			<scp:label id="plUserName" runat="server" controlname="txtUsername" text="User Name:"></scp:label></td>
		<td class="NormalBold" noWrap>
	...
	<tr id="PasswordRow" runat="server">
		<td class="SubHead" width="175">
			<scp:label id="plPassword" runat="server" controlname="txtPassword" text="Password:"></scp:label></td>
		<td class="NormalBold" noWrap>
	...
	<tr id="ConfirmPasswordRow" runat="server">
		<td class="SubHead" width="175">
			<scp:label id="plConfirm" runat="server" controlname="txtConfirm" text="Confirm:"></scp:label></td>
		<td class="NormalBold" noWrap>
	...
	<tr>
		<td class="SubHead" width="175">
			<scp:label id="plEmail" runat="server" controlname="txtEmail" text="Email Address:"></scp:label></td>
		<td class="NormalBold" noWrap>
	...
	<tr>
		<td class="SubHead" width="175">
			<scp:label id="plWebsite" runat="server" controlname="txtWebsite" text="Website:"></scp:label></td>
		<td class="NormalBold" noWrap>
			<asp:textbox id="txtWebsite" tabIndex="7" runat="server" cssclass="NormalTextBox" size="25" maxlength="175"></asp:textbox></td>
	</tr>
	<tr>
		<td class="SubHead" width="175">
			<scp:label id="plIM" runat="server" controlname="txtIM" text="Instant Messaging ID:"></scp:label></td>
		<td class="NormalBold" noWrap>
