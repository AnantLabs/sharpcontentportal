<%@ Control Language="C#" AutoEventWireup="true"  Inherits="SharpContent.UI.UserControls.Address" %>
...
<table cellSpacing="0" cellPadding="1" border="0" summary="Address Design Table">
	<tr id="rowStreet" runat="server">
		<td class="SubHead" width="120"><scp:label id="plStreet" runat="server" controlname="txtStreet" text="Street:"></scp:label></td>
	...
	<tr id="rowUnit" runat="server">
		<td class="SubHead" width="120"><scp:label id="plUnit" runat="server" controlname="txtUnit" text="Unit:"></scp:label></td>
		<td valign="top" nowrap>
	...
	<tr id="rowCity" runat="server">
		<td class="SubHead" width="120"><scp:label id="plCity" runat="server" controlname="txtCity" text="City:"></scp:label></td>
		<td valign="top" nowrap>
	...
	<tr id="rowCountry" runat="server">
		<td class="SubHead" width="120"><scp:label id="plCountry" runat="server" controlname="cboCountry" text="Country:"></scp:label></td>
		<td valign="top" nowrap>
	...
	<tr id="rowRegion" runat="server">
		<td class="SubHead" width="120"><scp:label id="plRegion" runat="server" controlname="cboRegion" text="Region:"></scp:label></td>
		<td valign="top" nowrap>
	...
	<tr id="rowPostal" runat="server">
		<td class="SubHead" width="120"><scp:label id="plPostal" runat="server" controlname="txtPostal" text="Postal Code:"></scp:label></td>
		<td valign="top" nowrap>
	...
	<tr id="rowTelephone" runat="server">
		<td class="SubHead" width="120"><scp:label id="plTelephone" runat="server" controlname="txtTelephone" text="Telephone:"></scp:label></td>
		<td valign="top" nowrap>
	...
	<tr id="rowCell" runat="server">
		<td class="SubHead" width="120"><scp:label id="plCell" runat="server" controlname="txtCell" text="Cell:"></scp:label></td>
		<td valign="top" nowrap>
	...
	<tr id="rowFax" runat="server">
		<td class="SubHead" width="120"><scp:label id="plFax" runat="server" controlname="txtFax" text="Fax:"></scp:label></td>
		<td valign="top" nowrap>
