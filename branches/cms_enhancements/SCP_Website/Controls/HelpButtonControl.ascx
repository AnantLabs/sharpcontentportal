<%@ Control Language="C#" AutoEventWireup="true" Inherits="SharpContent.UI.UserControls.HelpButtonControl" targetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
