<%@ Control Language="C#" AutoEventWireup="true" Inherits="SharpContent.Modules.Admin.PortalManagement.Template" CodeFile="Template.ascx.cs" %>
<%@ Register TagPrefix="scp" TagName="Label" Src="~/controls/LabelControl.ascx" %>
<table cellspacing="1" cellpadding="1" border="0">
	<tr>
		<td class="SubHead" style="width: 150;" valign="top"><scp:label id="plPortals" text="Portal:" controlname="cboPortals" runat="server" /></td>
		<td><asp:dropdownlist id="cboPortals" runat="server" width="300px"></asp:dropdownlist></td>
	</tr>
	<tr>
		<td class="SubHead" style="width: 150;" valign="top"><scp:label id="plTemplateName" text="Template Filename:" controlname="txtTemplateName" runat="server" /></td>
		<td>
	...
	<tr>
		<td class="SubHead" style="width: 150;" valign="top"><scp:label id="plDescription" text="Template Description:" controlname="txtDescription" runat="server" /></td>
		<td>
	...
	<tr>
		<td class="SubHead" style="width: 150;" valign="top">
			<scp:label id="plContent" runat="server" controlname="chkContent" text="Include Content:"></scp:label></td>
		<td>
