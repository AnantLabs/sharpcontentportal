...
<%@ Register Src="~/controls/SkinControl.ascx" TagName="Skin" TagPrefix="scp" %>
<%@ Register Src="~/controls/LabelControl.ascx" TagName="Label" TagPrefix="scp" %>
<%@ Register Src="~/controls/SectionHeadControl.ascx" TagName="SectionHead" TagPrefix="scp" %>
<%@ Control AutoEventWireup="true" CodeFile="SiteSettings.ascx.cs" EnableViewState="True" Inherits="SharpContent.Modules.Admin.PortalManagement.SiteSettings" Language="C#" %>
<!-- Settings Tables -->
    ...
    <tr>
        <td valign="top" style="width: 560;">
            <asp:Panel ID="pnlSettings" runat="server" CssClass="WorkPanel" Visible="True">
                <scp:SectionHead ID="dshBasic" runat="server" CssClass="Head" IncludeRule="True" ResourceKey="BasicSettings" Section="tblBasic" Text="Basic Settings" />
                <table id="tblBasic" runat="server" border="0" cellpadding="2" cellspacing="0" summary="Basic Settings Design Table" style="width: 525;">
                    ...
                    <tr>
                        ...
                        <td valign="top" style="width: 475;">
                            <scp:SectionHead ID="dshSite" runat="server" CssClass="Head" ResourceKey="SiteDetails" Section="tblSite" Text="Site Details" />
                            <table id="tblSite" runat="server" border="0" cellpadding="2" cellspacing="2" summary="Site Details Design Table">
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plPortalName" runat="server" ControlName="txtPortalName" Text="Title:" />
                                    </td>
                                ...
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <scp:Label ID="plDescription" runat="server" ControlName="txtDescription" Text="Description:" />
                                    </td>
                                ...
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <scp:Label ID="plKeyWords" runat="server" ControlName="txtKeyWords" Text="Key Words:" />
                                    </td>
                                    <td class="NormalTextBox" style="width: 325;">
                            ...
                            <br/>
                            <scp:SectionHead ID="dshAppearance" runat="server" CssClass="Head" ResourceKey="Appearance" Section="tblAppearance" Text="Appearance" />
                            <table id="tblAppearance" runat="server" border="0" cellpadding="2" cellspacing="2" summary="Appearance Design Table">
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <scp:Label ID="plLogo" runat="server" ControlName="ctlLogo" Suffix="" />
                                    </td>
                                    <td style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <scp:Label ID="plBackground" runat="server" ControlName="cboBackground" Text="Body Background:" />
                                    </td>
                                    <td style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plPortalSkin" runat="server" ControlName="ctlPortalSkin" Text="Portal Skin:" />
                                    </td>
                                    <td valign="top" style="width: 325;">
                                        <scp:Skin ID="ctlPortalSkin" runat="server" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plPortalContainer" runat="server" ControlName="ctlPortalContainer" Text="Portal Container:" />
                                    </td>
                                    <td valign="top" style="width: 325;">
                                        <scp:Skin ID="ctlPortalContainer" runat="server" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plAdminSkin" runat="server" ControlName="ctlAdminSkin" Text="Admin Skin:" />
                                    </td>
                                    <td valign="top" style="width: 325;">
                                        <scp:Skin ID="ctlAdminSkin" runat="server" />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plAdminContainer" runat="server" ControlName="ctlAdminContainer" Text="Admin Container:" />
                                    </td>
                                    <td valign="top" style="width: 325;">
                                        <scp:Skin ID="ctlAdminContainer" runat="server" />
                                    </td>
                                </tr>
                                <tr>
                ...
                <br/>
                <scp:SectionHead ID="dshAdvanced" runat="server" CssClass="Head" IncludeRule="True" IsExpanded="False" ResourceKey="AdvancedSettings" Section="tblAdvanced" Text="Advanced Settings" />
                <table id="tblAdvanced" runat="server" border="0" cellpadding="2" cellspacing="0" summary="Advanced Settings Design Table" width="525">
                    ...
                    <tr>
                        ...
                        <td valign="top" style="width: 475;">
                            <scp:SectionHead ID="dhsSecurity" runat="server" CssClass="Head" ResourceKey="SecuritySettings" Section="tblSecurity" Text="Security Settings" />
                            <table id="tblSecurity" runat="server" border="0" cellpadding="2" cellspacing="2" summary="Security Settings Design Table">
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plUserRegistration" runat="server" ControlName="optUserRegistration" Text="User Registration:" />
                                    </td>
                                    <td class="NormalTextBox" valign="top" style="width: 325;">
                            ...
                            <br/>
                            <scp:SectionHead ID="dshPages" runat="server" CssClass="Head" ResourceKey="Pages" Section="tblPages" Text="Page Management" />
                            <table id="tblPages" runat="server" border="0" cellpadding="2" cellspacing="2" summary="Page Management Design Table">
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plSplashTabId" runat="server" ControlName="cboSplashTabId" Text="Splash Page:" />
                                    </td>
                                    <td class="NormalTextBox" valign="top" style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plHomeTabId" runat="server" ControlName="cboHomeTabId" Text="Home Page:" />
                                    </td>
                                    <td class="NormalTextBox" valign="top" style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plLoginTabId" runat="server" ControlName="cboLoginTabId" Text="Login Page:" />
                                    </td>
                                    <td class="NormalTextBox" valign="top" style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plUserTabId" runat="server" ControlName="cboUserTabId" Text="User Page:" />
                                    </td>
                                    <td class="NormalTextBox" valign="top" style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <scp:Label ID="plHomeDirectory" runat="server" ControlName="txtHomeDirectory" Text="Home Directory:" />
                                    </td>
                                    <td class="NormalTextBox" style="width: 325;">
                            ...
                            <br/>
                            <scp:SectionHead ID="dshPayment" runat="server" CssClass="Head" IsExpanded="False" ResourceKey="Payment" Section="tblPayment" Text="Payment Settings" />
                            <table id="tblPayment" runat="server" border="0" cellpadding="2" cellspacing="2" summary="Payment Setttings Design Table">
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plCurrency" runat="server" ControlName="cboCurrency" Text="Currency:" />
                                    </td>
                                    <td class="NormalTextBox" valign="top" style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <scp:Label ID="plProcessor" runat="server" ControlName="cboProcessor" Text="Payment Processor:" />
                                    </td>
                                    <td class="NormalTextBox" valign="top" style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plUserId" runat="server" ControlName="txtUserId" Text="Processor UserId:" />
                                    </td>
                                    <td class="NormalTextBox" valign="top" style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plPassword" runat="server" ControlName="txtPassword" Text="Processor Password:" />
                                    </td>
                                    <td class="NormalTextBox" valign="top" style="width: 325;">
                            ...
                            <br/>
                            <scp:SectionHead ID="dsOther" runat="server" CssClass="Head" IsExpanded="False" ResourceKey="Other" Section="tblOther" Text="Other Settings" />
                            <table id="tblOther" runat="server" border="0" cellpadding="2" cellspacing="2" summary="Other Setttings Design Table">
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plFooterText" runat="server" ControlName="txtFooterText" Text="Copyright:" />
                                    </td>
                                    <td class="NormalTextBox" style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plBannerAdvertising" runat="server" ControlName="optBannerAdvertising" Text="Banner Advertising:" />
                                    </td>
                                    <td class="NormalTextBox" style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plAdministrator" runat="server" ControlName="cboAdministratorId" Text="Administrator:" />
                                    </td>
                                    <td class="NormalTextBox" style="width: 325;">
                                        <asp:DropDownList ID="cboAdministratorId" runat="server" CssClass="NormalTextBox" DataTextField="Username" DataValueField="UserId" Width="300">
                                        </asp:DropDownList></td>
                                </tr>                                
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plDefaultLanguage" runat="server" ControlName="cboDefaultLanguage" Text="Default Language:" />
                                    </td>
                                    <td style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plTimeZone" runat="server" ControlName="cboTimeZone" Text="Portal TimeZone:" />
                                    </td>
                                    <td style="width: 325;">
                            ...
                            <br/>
                            <scp:SectionHead ID="dshHost" runat="server" CssClass="Head" IsExpanded="False" ResourceKey="HostSettings" Section="tblHost" Text="Host Settings" />
                            <table id="tblHost" runat="server" border="0" cellpadding="2" cellspacing="2" summary="Host Settings Design Table">
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plExpiryDate" runat="server" ControlName="txtExpiryDate" Text="Expiry Date:" />
                                    </td>
                                    <td class="NormalTextBox" style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plHostFee" runat="server" ControlName="txtHostFee" Text="Hosting Fee:" />
                                    </td>
                                    <td class="NormalTextBox" style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plHostSpace" runat="server" ControlName="txtHostSpace" Text="Disk Space:" />
                                    </td>
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plPageQuota" runat="server" ControlName="txtPageQuota" Text="Page Quota:" />
                                    </td>
                                    <td class="NormalTextBox" style="width: 325px;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plUserQuota" runat="server" ControlName="txtUserQuota" Text="User Quota:" />
                                    </td>
                                    <td class="NormalTextBox" style="width: 325px;">
                                ...
                                <tr>
                                    <td class="SubHead" style="width: 150;">
                                        <scp:Label ID="plSiteLogHistory" runat="server" ControlName="txtSiteLogHistory" Text="Site Log History:" />
                                    </td>
                                    <td class="NormalTextBox" style="width: 325;">
                                ...
                                <tr>
                                    <td class="SubHead" valign="top" style="width: 150;">
                                        <br/>
                                        <br/>
                                        <scp:Label ID="plDesktopModules" runat="server" ControlName="ctlDesktopModules" Text="Premium Modules:" />
                                    </td>
                                    <td class="NormalTextBox" style="width: 325;">
                ...
                <br/>
                <scp:SectionHead ID="dshStylesheet" runat="server" CssClass="Head" IncludeRule="True" IsExpanded="False" ResourceKey="StylesheetEditor" Section="tblStylesheet" Text="Stylesheet Editor" />
