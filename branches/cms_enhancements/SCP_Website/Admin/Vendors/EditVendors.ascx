<%@ Control Language="C#" AutoEventWireup="true" Inherits="SharpContent.Modules.Admin.Vendors.EditVendors"
...
<%@ Register TagPrefix="scp" TagName="Audit" Src="~/controls/ModuleAuditControl.ascx" %>
            ...
            <table cellspacing="0" cellpadding="0" border="0" summary="Edit Vendors Design Table">
                <tr>
                    <td valign="top" width="560">
                        <scp:SectionHead id="dshSettings" runat="server" cssclass="Head" includerule="True"
                        ...
                        <table id="tblSettings" runat="server" cellspacing="2" cellpadding="2" border="0"
                            ...
                            <tr valign="top">
                                <td class="SubHead" width="120">
                                    <scp:Label id="plVendorName" runat="server" controlname="txtVendorName" suffix=":">
                                    </scp:Label></td>
                            ...
                            <tr valign="top">
                                <td class="SubHead" width="120">
                                    <scp:Label id="plFirstName" runat="server" controlname="txtFirstName" suffix=":">
                                    </scp:Label></td>
                            ...
                            <tr valign="top">
                                <td class="SubHead" width="120">
                                    <scp:Label id="plLastName" runat="server" controlname="txtLastName" suffix=":">
                                    </scp:Label></td>
                                <td class="NormalBold" nowrap>
                        ...
                        <br>
                        <scp:SectionHead id="dshAddress" runat="server" cssclass="Head" includerule="True"
                        ...
                        <table id="tblAddress" runat="server" cellspacing="2" cellpadding="2" border="0"
                            ...
                            <tr>
                                <td>
                                    <scp:address runat="server" id="addresssVendor" /></td>
                            </tr>
                        </table>
                        <br>
                        <scp:SectionHead id="dshOther" runat="server" cssclass="Head" includerule="True"
                        ...
                        <table id="tblOther" runat="server" cellspacing="2" cellpadding="2" border="0" summary="Edit Vendors Design Table">
                            <tr valign="top">
                                <td class="SubHead" width="120">
                                    <scp:Label id="plWebsite" runat="server" controlname="txtWebsite" suffix=":">
                                    </scp:Label></td>
                                <td>
                            ...
                            <tr id="rowVendor2" runat="server" valign="top">
                                <td class="SubHead" width="120">
                                    <scp:Label id="plAuthorized" runat="server" controlname="chkAuthorized" suffix=":">
                                    </scp:Label></td>
                                <td>
                        ...
                        <asp:Panel ID="pnlVendor" runat="server">
                            <scp:SectionHead id="dshClassification" runat="server" cssclass="Head" includerule="True"
                            ...
                            <table id="tblClassification" runat="server" cellspacing="2" cellpadding="2" border="0"
                                ...
                                <tr valign="top">
                                    <td class="SubHead" align="center" width="200">
                                        <scp:Label id="plClassifications" runat="server" controlname="lstClassifications"
                                            suffix=":">
                                        </scp:Label></td>
                                    <td width="60">
                                    </td>
                                    <td class="SubHead" align="center" width="200">
                                        <scp:Label id="plKeyWords" runat="server" controlname="txtKeyWords" suffix=":">
                                        </scp:Label></td>
                                </tr>
                                <tr valign="top">
                        ...
                        <asp:PlaceHolder ID="pnlBanners" runat="server">
                            <scp:SectionHead id="dshBanners" runat="server" cssclass="Head" includerule="True"
                        ...
                        <asp:PlaceHolder ID="pnlAffiliates" runat="server">
                            <scp:SectionHead id="dshAffiliates" runat="server" cssclass="Head" includerule="True"
    ...
    <tr>
        <td>
            <asp:Panel ID="pnlAudit" runat="server">
                <scp:audit id="ctlAudit" runat="server" />
            </asp:Panel>
        </td>
    </tr>
</table>
