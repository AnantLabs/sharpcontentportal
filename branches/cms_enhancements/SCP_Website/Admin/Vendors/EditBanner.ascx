<%@ Control Language="C#" AutoEventWireup="true" Inherits="SharpContent.Modules.Admin.Vendors.EditBanner" CodeFile="EditBanner.ascx.cs" %>
...
<table cellspacing="2" cellpadding="0" width="560" summary="Edit Banner Design Table">
    ...
    <tr valign="top">
        <td class="SubHead" width="125">
            <scp:label id="plBannerName" runat="server" controlname="txtBannerName" suffix=":">
            </scp:label></td>
        <td width="400">
    ...
    <tr valign="top">
        <td class="SubHead" width="125">
            <scp:label id="plBannerType" runat="server" controlname="cboBannerType" suffix=":">
            </scp:label></td>
        <td width="400">
    ...
    <tr valign="top">
        <td class="SubHead" width="125">
            <scp:label id="plBannerGroup" runat="server" controlname="txtBannerGroup" suffix=":">
            </scp:label></td>
        <td width="400">
    ...
    <tr>
        <td class="SubHead" width="125">
            <scp:label id="plImage" runat="server" controlname="ctlImage" suffix=":">
            </scp:label></td>
        <td width="400">
    ...
    <tr valign="top">
        <td class="SubHead" width="125">
            <scp:label id="plWidth" runat="server" controlname="txtWidth" suffix=":">
            </scp:label></td>
        <td width="400">
    ...
    <tr valign="top">
        <td class="SubHead" width="125">
            <scp:label id="plHeight" runat="server" controlname="txtHeight" suffix=":">
            </scp:label></td>
        <td width="400">
    ...
    <tr valign="top">
        <td class="SubHead" width="125" valign="middle">
            <scp:label id="plDescription" runat="server" controlname="txtDescription" suffix=":">
            </scp:label></td>
        <td width="400">
    ...
    <tr>
        <td class="SubHead" width="125">
            <scp:label id="plURL" runat="server" controlname="ctlURL" suffix=":">
            </scp:label></td>
        <td width="400">
    ...
    <tr>
        <td class="SubHead" width="125">
            <scp:label id="plCPM" runat="server" controlname="txtCPM" suffix=":">
            </scp:label></td>
        <td width="400">
    ...
    <tr>
        <td class="SubHead" width="125">
            <scp:label id="plImpressions" runat="server" controlname="txtImpressions" suffix=":">
            </scp:label></td>
        <td width="400">
    ...
    <tr>
        <td class="SubHead" width="125">
            <scp:label id="plStartDate" runat="server" controlname="txtStartDate" suffix=":">
            </scp:label></td>
        <td width="400">
    ...
    <tr>
        <td class="SubHead" width="125">
            <scp:label id="plEndDate" runat="server" controlname="txtEndDate" suffix=":">
            </scp:label></td>
        <td width="400">
    ...
    <tr>
        <td class="SubHead" width="125">
            <scp:label id="plCriteria" runat="server" controlname="optCriteria" suffix=":">
            </scp:label></td>
        <td>
