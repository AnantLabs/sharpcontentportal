<%@ Control AutoEventWireup="true" CodeFile="Languages.ascx.cs" Inherits="SharpContent.Services.Localization.Languages" Language="C#" %>
...
<scp:SectionHead ID="dshBasic" runat="server" CssClass="Head" IncludeRule="False" ResourceKey="SupportedLocales" Section="tblBasic" Text="Suported Locales" />
<br/>
...
<asp:Panel ID="pnlAdd" runat="server">
    ...
    <scp:SectionHead ID="dshAdd" runat="server" CssClass="Head" IncludeRule="False" ResourceKey="AddNewLocale" Section="tblAdd" Text="Add New Locale" />
    <br/>
    <table id="tblAdd" runat="server" border="0" cellpadding="1" cellspacing="1">
        ...
        <tr>
            <td class="SubHead" nowrap="nowrap" valign="top" width="150">
                <scp:Label ID="lbLocale" runat="server" ControlName="txtName" Text="Name" />
            </td>
