<%@ Control AutoEventWireup="true" CodeFile="SearchResults.ascx.cs"  Inherits="SharpContent.Modules.SearchResults.SearchResults" Language="C#" %>
...
<asp:Label ID="lblNoResults" runat="server" CssClass="Normal" Visible="false">No Results found!</asp:Label>
