<%@ Control AutoEventWireup="true" CodeFile="RecycleBin.ascx.cs" Inherits="SharpContent.Modules.Admin.Tabs.RecycleBin" Language="C#" %>
<%@ Register Src="~/controls/LabelControl.ascx" TagName="Label" TagPrefix="scp" %>
<%@ Register Src="~/controls/HelpButtonControl.ascx" TagName="HelpButton" TagPrefix="scp" %>
    ...
    <tr>
        <td width="560">
            <asp:Panel ID="pnlTabs" runat="server" CssClass="WorkPanel" Visible="True">
                <scp:SectionHead ID="dshBasic" runat="server" CssClass="Head" IncludeRule="True" ResourceKey="Tabs" Section="tblTabs" Text="Tabs" />
                        ...
                        <td valign="top">
                            <table summary="Tabs Design Table">
                                <tr>
                                    ...
                                    <td valign="top">
                                        <scp:HelpButton ID="hbtnRestoreTabHelp" runat="server" ResourceKey="cmdRestoreTab" />
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top">
                                    ...
                                    <td valign="top">
                                        <scp:HelpButton ID="hbtnDeleteTabHelp" runat="server" ResourceKey="cmdDeleteTab" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <br>
                <scp:SectionHead ID="Sectionhead1" runat="server" CssClass="Head" IncludeRule="True" ResourceKey="Modules" Section="tblModules" Text="Modules" />
                <table id="tblModules" runat="server" border="0" cellpadding="0" cellspacing="0" summary="Basic Settings Design Table" width="525">
                        ...
                        <td valign="top">
                            <table summary="Tabs Design Table">
                                <tr>
                                    ...
                                    <td valign="top">
                                        <scp:HelpButton ID="hbtnRestoreModuleHelp" runat="server" ResourceKey="cmdRestoreModule" />
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top">
                                    ...
                                    <td valign="top">
                                        <scp:HelpButton ID="hbtnDeleteModuleHelp" runat="server" ResourceKey="cmdDeleteModule" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td align="center" class="SubHead">
                            <scp:Label ID="plTab" runat="server" ControlName="cboTab" HelpKey="TabHelp" ResourceKey="Tab" Suffix=":" />
                        </td>
                        <td>
                            &nbsp;</td>
                    </tr>
