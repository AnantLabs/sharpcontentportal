...
<%@ Control Language="C#" CodeFile="EditModuleDefinition.ascx.cs" AutoEventWireup="true" Inherits="SharpContent.Modules.Admin.ModuleDefinitions.EditModuleDefinition" %>
	...
	<tr>
		<td>
			<table id="tabManifest" runat="server" border="0" cellpadding="4" cellspacing="0" summary="Manifest Design Table">
				<tr>
					<td class="SubHead" style="width: 150;"><scp:label id="plManifest" text="Manifest:" controlname="cboManifest" runat="server" /></td>
					<td>
            ...
            <table id="tabModule" runat="server" border="0" cellpadding="4" cellspacing="0" summary="Module Definitions Design Table">
                <tr>
					<td class="SubHead" style="width: 150;"><scp:label id="plModuleName" text="Module Name:" controlname="txtModuleName" runat="server" /></td>
					<td>
				...
				<tr>
					<td class="SubHead" style="width: 150;"><scp:label id="plFolderName" text="Folder Name:" controlname="txtFolderName" runat="server" /></td>
					<td>
				...
				<tr>
					<td class="SubHead" style="width: 150;"><scp:label id="plFriendlyName" text="Friendly Name:" controlname="txtFriendlyName" runat="server" /></td>
					<td>
				...
				<tr>
					<td class="SubHead" style="width: 150;" valign="top"><scp:label id="plDescription" text="Description:" controlname="txtDescription" runat="server" /></td>
				...
				<tr>
					<td class="SubHead" style="width: 150;" valign="top"><scp:label id="plVersion" text="Version:" controlname="txtVersion" runat="server" /></td>
                    <td>
                ...
                <tr>
                    <td class="SubHead" valign="top" style="width:150;">
                        <scp:Label ID="plCompatibleVersions" runat="server" ControlName="txtCompatibleVersions" Text="Compatibility:" />
                    </td>
                    <td>
				...
				<tr>
					<td class="SubHead" style="width: 150;"><scp:label id="plBusinessClass" text="Business Controller Class:" controlname="txtBusinessClass"
							runat="server" /></td>
					<td>
				...
				<tr>
					<td class="SubHead" style="width: 150;"><scp:label id="plSupportedFeatures" text="Supported Features:" controlname="txtSupportedFeatures"
							runat="server" /></td>
					<td class="SubHead" valign="top">
						<asp:checkbox id="chkPortable" runat="server" cssclass="NormalTextBox" AutoPostBack="False" enabled="False" />&nbsp;
						<scp:label id="plPortable" text="Portable" controlname="txtPortable" runat="server" />
						<asp:checkbox id="chkSearchable" runat="server" cssclass="NormalTextBox" AutoPostBack="False"
							enabled="False" />&nbsp;
						<scp:label id="plSearchable" text="Searchable" controlname="txtSearchable" runat="server" />
						<asp:checkbox id="chkUpgradeable" runat="server" cssclass="NormalTextBox" AutoPostBack="False"
							enabled="False" />&nbsp;
						<scp:label id="plUpgradeable" text="Upgradeable" controlname="txtUpgradeable" runat="server" />
					</td>
				</tr>
				<tr>
					<td class="SubHead" style="width: 150;" valign="top"><scp:label id="plPremium" text="Premium?" controlname="chkPremium" runat="server" /></td>
					<td>
			...
			<table id="tabDefinitions" runat="server" cellspacing="0" cellpadding="4" border="0" summary="Module Definitions Design Table">
				<tr>
					<td class="SubHead" style="width: 150;" valign="top"><scp:label id="plDefinitions" text="Definitions:" controlname="cboDefinitions" runat="server" /></td>
					<td>
				...
				<tr>
					<td class="SubHead" style="width: 150;" valign="top"><scp:label id="plDefinition" text="New Definition:" controlname="txtDefinition" runat="server" /></td>
					<td>
			...
			<table id="tabCache" runat="server" cellspacing="0" cellpadding="4" border="0" width="100%"
				...
				<tr>
					<td class="SubHead" style="width: 150;" valign="top"><scp:label id="plCacheTime" text="Default Cache Time:" controlname="txtCacheTime" runat="server" /></td>
					<td>
