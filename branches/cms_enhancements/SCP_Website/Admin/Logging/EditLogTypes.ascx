<%@ Control AutoEventWireup="true" CodeFile="EditLogTypes.ascx.cs" Inherits="SharpContent.Modules.Admin.Log.EditLogTypes" Language="C#" %>
...
<asp:Panel ID="pnlEditLogTypeConfigInfo" runat="server">
    <scp:SectionHead ID="dshSettings" runat="server" CssClass="Head" IncludeRule="True" ResourceKey="Settings" Section="tblSettings" Text="Logging Settings" />
    <table id="tblSettings" runat="server" border="0" cellpadding="2" cellspacing="2">
        <tr>
            <td class="SubHead" width="150">
                <scp:Label ID="plIsActive" runat="server" ControlName="chkIsActive" Suffix=":" />
            </td>
            <td class="Normal">
        ...
        <tr>
            <td class="SubHead" width="150">
                <scp:Label ID="plLogTypeKey" runat="server" ControlName="ddlLogTypeKey" Suffix=":" />
            </td>
            <td class="Normal">
        ...
        <tr>
            <td class="SubHead" width="150">
                <scp:Label ID="plLogTypePortalID" runat="server" ControlName="ddlLogTypePortalID" Suffix=":" />
            </td>
            <td class="Normal">
        ...
        <tr>
            <td class="SubHead" width="150">
                <scp:Label ID="plKeepMostRecent" runat="server" ControlName="ddlKeepMostRecent" Suffix=":" />
            </td>
            <td class="Normal">
        ...
        <tr>
            <td class="SubHead" width="150">
                <scp:Label ID="plFileName" runat="server" ControlName="txtFileName" Suffix=":" />
            </td>
            <td class="Normal">
    ...
    <br>
    <scp:SectionHead ID="dshEmailSettings" runat="server" CssClass="Head" IncludeRule="True" ResourceKey="EmailSettings" Section="tblEmailSettings" Text="Email Notification Settings" />
    <table id="tblEmailSettings" runat="server" border="0" cellpadding="2" cellspacing="2">
        <tr>
            <td class="SubHead" width="180">
                <scp:Label ID="plEmailNotificationStatus" runat="server" ControlName="chkEmailNotificationStatus" Suffix=":" />
            </td>
            <td class="Normal">
        ...
        <tr>
            <td class="SubHead" width="180">
                <scp:Label ID="plThreshold" runat="server" ControlName="ddlThreshold" Suffix=":" />
            </td>
            <td class="Normal">
        ...
        <tr>
            <td class="SubHead" width="180">
                <scp:Label ID="plMailFromAddress" runat="server" ControlName="txtMailFromAddress" Suffix=":" />
            </td>
            <td class="Normal">
        ...
        <tr>
            <td class="SubHead" width="180">
                <scp:Label ID="plMailToAddress" runat="server" ControlName="txtMailToAddress" Suffix=":" />
            </td>
            <td class="Normal">
