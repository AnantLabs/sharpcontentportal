...
<%@ Control AutoEventWireup="true" CodeFile="LogViewer.ascx.cs"  Inherits="SharpContent.Modules.Admin.Log.LogViewer" Language="C#" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<style type="text/css">  
...
<asp:Panel ID="pnlOptions" runat="server">
    <table border="0" width="100%">
        <tr>
            <td valign="top">
                <scp:SectionHead ID="dshSettings" runat="server" CssClass="Head" meta:resourcekey="Settings" Section="tblSettings" Text="Viewer Settings" />
                <table id="tblSettings" runat="server" border="0" cellpadding="2" cellspacing="2">
                    <tr>
                        <td align="left" class="SubHead" nowrap="nowrap" width="110">
                            <scp:Label ID="plPortalID" runat="server" ControlName="ddlPortalid" Suffix=":" />
                        </td>
                        <td width="60">
                        ...
                        <td align="left" class="SubHead" width="100">
                            <scp:Label ID="plLogType" runat="server" ControlName="ddlLogType" Suffix=":" />
                        </td>
                        <td width="100">
                    ...
                    <tr>
                        <td align="left" class="SubHead" nowrap="nowrap">
                            <scp:Label ID="plRecordsPage" runat="server" meta:resourcekey="plRecordsPage" Suffix=":" />
                        </td>
                        <td width="25">
                        ...
                        <td class="SubHead" colspan="2">
                            <asp:CheckBox ID="chkColorCoding" runat="server" AutoPostBack="true" meta:resourcekey="ColorCoding" Text="Color Coding On" OnCheckedChanged="chkColorCoding_CheckedChanged" /></td>
                        <td width="*">
                            &nbsp;</td>
                    </tr>
                    <tr>
                            ...
                            <table id="tblInstructions" runat="server" border="0" width="100%">
                                ...
                                <tr>
                                    <td align="center" class="Normal">
                                        <asp:Label ID="lbClickRow" runat="server" meta:resourcekey="ClickRow">Click on a row for details.</asp:Label><br />
                                    </td>
                                </tr>
                                <tr>
            ...
            <td align="left" class="SubHead" rowspan="3" valign="top" width="230">
                <asp:Panel ID="pnlLegend" runat="server" HorizontalAlign="Center">
                    <scp:SectionHead ID="dshLegend" runat="server" CssClass="Head" IsExpanded="False" meta:resourcekey="Legend" Section="tblLegend" Text="Color Coding Legend" />
                            ...
                            <td bgcolor="#ffffff">
                                <table border="0">
                                    <tr>
                                        ...
                                        <td class="Normal">
                                            <asp:Label ID="Label1" runat="server" meta:resourcekey="ExceptionCode">Exception</asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table bgcolor="#000000" border="0" cellpadding="3" cellspacing="1">
                                        ...
                                        <td class="Normal">
                                            <asp:Label ID="Label2" runat="server" meta:resourcekey="ItemCreatedCode">Item Created</asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table bgcolor="#000000" border="0" cellpadding="3" cellspacing="1">
                                        ...
                                        <td class="Normal">
                                            <asp:Label ID="Label3" runat="server" meta:resourcekey="ItemUpdatedCode">Item Updated</asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table bgcolor="#000000" border="0" cellpadding="3" cellspacing="1">
                                        ...
                                        <td class="Normal">
                                            <asp:Label ID="Label4" runat="server" meta:resourcekey="ItemDeletedCode">Item Deleted</asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table bgcolor="#000000" border="0" cellpadding="3" cellspacing="1">
                                        ...
                                        <td class="Normal">
                                            <asp:Label ID="Label5" runat="server" meta:resourcekey="SuccessCode">Operation Success</asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table bgcolor="#000000" border="0" cellpadding="3" cellspacing="1">
                                        ...
                                        <td class="Normal">
                                            <asp:Label ID="Label6" runat="server" meta:resourcekey="FailureCode">Operation Failure</asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table bgcolor="#000000" border="0" cellpadding="3" cellspacing="1">
                                        ...
                                        <td class="Normal">
                                            <asp:Label ID="Label7" runat="server" meta:resourcekey="AdminOpCode">General Admin Operation</asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table bgcolor="#000000" border="0" cellpadding="3" cellspacing="1">
                                        ...
                                        <td class="Normal">
                                            <asp:Label ID="Label8" runat="server" meta:resourcekey="AdminAlertCode">Admin Alert</asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table bgcolor="#000000" border="0" cellpadding="3" cellspacing="1">
                                        ...
                                        <td class="Normal">
                                            <asp:Label ID="Label9" runat="server" meta:resourcekey="HostAlertCode">Host Alert</asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <table bgcolor="#000000" border="0" cellpadding="3" cellspacing="1">
                                        ...
                                        <td class="Normal">
                                            <asp:Label ID="Label10" runat="server" meta:resourcekey="SecurityException">Security Exception</asp:Label></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
...
<asp:DataList ID="dlLog" runat="server" BackColor="#CFCFCF" CellPadding="0" CellSpacing="1" EnableViewState="False" Width="100%">
    ...
    <HeaderTemplate>
        ...
        <asp:Label ID="lblDateHeader" runat="server" class="NormalBold" meta:resourcekey="Date" Style="width: 150; background: #CFCFCF;">&nbsp;Date</asp:Label>
        <asp:Label ID="lblTypeHeader" runat="server" class="NormalBold" meta:resourcekey="Type" Style="width: 200; background: #CFCFCF;">&nbsp;Log Type</asp:Label>
        <asp:Label ID="lblUserHeader" runat="server" class="NormalBold" meta:resourcekey="Username" Style="width: 100; background: #CFCFCF;">&nbsp;Username</asp:Label>
        <asp:Label ID="lblPortalHeader" runat="server" class="NormalBold" meta:resourcekey="Portal" Style="width: 150; background: #CFCFCF;">&nbsp;Portal</asp:Label>
        <asp:Label ID="lblSummaryHeader" runat="server" class="NormalBold" meta:resourcekey="Summary" Style="width: 270; background: #CFCFCF;">&nbsp;Summary</asp:Label>
    </HeaderTemplate>
    <ItemTemplate>
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr class='<%# GetMyLogType(Convert.ToString(DataBinder.Eval(Container.DataItem,"LogTypeKey"))).LogTypeCSSClass %>'>
                <td align="center" valign="middle" width="20">
                    <input name="Exception" type="checkbox" value='<%# ((SharpContent.Services.Log.EventLog.LogInfo)Container.DataItem).LogGUID %>|<%# ((SharpContent.Services.Log.EventLog.LogInfo)Container.DataItem).LogFileID %>' /></td>
                <td nowrap="nowrap" onclick="flipFlop('<%# ((SharpContent.Services.Log.EventLog.LogInfo)Container.DataItem).LogGUID %>')">
                    ...
                    <span class="Normal" style="width: 150; overflow: hidden;">&nbsp;
                        <asp:Label ID="lblPortal" runat="server" EnableViewState="False" Text='<%# DataBinder.Eval(Container.DataItem,"LogPortalName") %>'></asp:Label></span> <span class="Normal"
                            ...
                            <asp:Label ID="lblSummary" runat="server" EnableViewState="False" Text='<%# ((SharpContent.Services.Log.EventLog.LogInfo)Container.DataItem).LogProperties.Summary %>'>
                            </asp:Label>&nbsp;...</span>
                </td>
            </tr>
            <tr id='<%# ((SharpContent.Services.Log.EventLog.LogInfo)Container.DataItem).LogGUID%>' style="display: none;">
...
<scp:PagingControl ID="ctlPagingControlBottom" runat="server" />
<p>
    <asp:LinkButton ID="btnDelete" runat="server" CssClass="CommandButton" meta:resourcekey="btnDelete" OnClick="btnDelete_Click">Delete Selected Exceptions</asp:LinkButton>
    &nbsp;&nbsp;
    <asp:LinkButton ID="btnClear" runat="server" CssClass="CommandButton" meta:resourcekey="btnClear" OnClick="btnClear_Click">Clear Log</asp:LinkButton>
</p>
<asp:Panel ID="pnlSendExceptions" runat="server" CssClass="Normal">
    <scp:SectionHead ID="dshSendExceptions" runat="server" CssClass="Head" IncludeRule="True" IsExpanded="False" meta:resourcekey="SendExceptions" Section="tblSendExceptions"
        Text="Send Exceptions" />
    <table id="tblSendExceptions" runat="server" border="0" cellpadding="2" cellspacing="2" width="560">
        <tr>
            <td colspan="3">
                <asp:Label ID="lblExceptionsWarning" runat="server" class="normal" meta:resourcekey="ExceptionsWarning">
          <B>Please note</B>: By using these features 
            ...
            will be sent.
                ...
                <asp:RadioButtonList ID="optEmailType" runat="server" AutoPostBack="False" CssClass="Normal" RepeatDirection="Horizontal">
                    <asp:ListItem meta:resourcekey="ToEmail" Selected="True" Value="Email">To Specified Email Address</asp:ListItem>
                </asp:RadioButtonList></td>
        </tr>
        <tr>
            <td align="left" class="SubHead" width="200">
                <scp:Label ID="plEmailAddress" runat="server" ControlName="txtEmailAddress" Suffix=":" />
            </td>
            <td width="200">
        ...
        <tr>
            <td align="left" class="SubHead" width="200">
                <scp:Label ID="plMessage" runat="server" ControlName="txtMessage" meta:resourcekey="SendMessage" Suffix=":" />
            </td>
            <td width="200">
        ...
        <tr>
            <td colspan="3">
                <asp:LinkButton ID="btnEmail" runat="server" CssClass="CommandButton" meta:resourcekey="btnEmail" OnClick="btnEmail_Click">Send Selected Exceptions</asp:LinkButton></td>
        </tr>
    </table>
</asp:Panel>
