<%@ Control Inherits="SharpContent.Modules.Admin.Tabs.Tabs" Language="C#" AutoEventWireup="true"  CodeFile="Tabs.ascx.cs" %>
<%@ Register TagPrefix="scp" TagName="HelpButton" Src="~/controls/HelpButtonControl.ascx" %>
							...
							<table summary="Tabs Design Table">
								...
								<tr>
									...
									<td valign="top" style="width: 90%;">
										<scp:HelpButton id="hbtnUpHelp" resourcekey="cmdUp" runat="server" />
									</td>
								</tr>
								<tr>
									<td valign="top" style="width: 10%;">
									...
									<td valign="top" style="width: 90%;">
										<scp:helpbutton id="hbtnDownHelp" resourcekey="cmdDown" runat="server" />
									</td>
								</tr>
								<tr>
									<td valign="top" style="width: 10%;">
									...
									<td valign="top" style="width: 90%;">
										<scp:helpbutton id="hbtnLeftHelp" resourcekey="cmdLeft" runat="server" />
									</td>
								</tr>
								<tr>
									<td valign="top" style="width: 10%;">
									...
									<td valign="top" style="width: 90%;">
										<scp:helpbutton id="hbtnRightHelp" resourcekey="cmdRight" runat="server" />
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td valign="top" style="width: 90%;">
										<scp:helpbutton id="hbtnEditHelp" resourcekey="cmdEdit" runat="server" />
									</td>
								</tr>
								<tr>
									<td valign="top" style="width: 10%;">
									...
									<td valign="top" style="width: 90%;">
										<scp:helpbutton id="hbtnViewHelp" resourcekey="cmdView" runat="server" />
									</td>
								</tr>
							</table>
						</td>
