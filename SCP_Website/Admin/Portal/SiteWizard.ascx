<%@ Control Inherits="SharpContent.Modules.Admin.PortalManagement.SiteWizard" Language="C#" AutoEventWireup="true"  enableViewState="True" CodeFile="SiteWizard.ascx.cs" %>
<%@ Register TagPrefix="scp" TagName="Skin" Src="~/controls/SkinThumbNailControl.ascx" %>
            ...
            <table border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                    <td class="SubHead" style="width: 150;">
                        <scp:label ID="lblPortalName" runat="server" ControlName="txtPortalName" Text="Name/Title:" />
                    </td>
                ...
                <tr>
                    <td class="SubHead" valign="top" style="width: 150;">
                        <scp:label ID="lblDescription" runat="server" Text="Description:" />
                    </td>
                ...
                <tr>
                    <td class="SubHead" valign="top" style="width: 150;">
                        <scp:label ID="lblKeyWords" runat="server" Text="Key Words:" />
                    </td>
                    <td align="left" class="NormalTextBox">
                ...
                <tr>
                    <td class="SubHead" valign="top" style="width: 120;">
                        <scp:label ID="lblLogo" runat="server" Text="Logo:" />
                    </td>
                    <td align="left" class="NormalTextBox">
                        <scp:url ID="urlLogo" runat="server" Required="false" ShowLog="False" ShowTabs="False" ShowTrack="false" ShowUrls="False" />
                    </td>
                </tr>
            </table>
        </asp:WizardStep>
