<%@ Control Language="C#" AutoEventWireup="true"  Inherits="SharpContent.Modules.Admin.ModuleDefinitions.EditModuleControl" CodeFile="EditModuleControl.ascx.cs" %>
...
<table cellspacing="0" cellpadding="4" border="0" summary="Module Controls Design Table">
	<tr>
		<td class="SubHead" width="150"><scp:label id="plModule" text="Module:" controlname="txtModule" runat="server" /></td>
		<td><asp:textbox id="txtModule" cssclass="NormalTextBox" width="390" columns="30" maxlength="150"
				runat="server" enabled="False" /></td>
	</tr>
	<tr>
		<td class="SubHead" width="150"><scp:label id="plDefinition" text="Definition:" controlname="txtDefinition" runat="server" /></td>
		<td><asp:textbox id="txtDefinition" cssclass="NormalTextBox" width="390" columns="30" maxlength="150"
				runat="server" enabled="False" /></td>
	</tr>
	<tr>
		<td class="SubHead" width="150"><scp:label id="plKey" text="Key:" controlname="txtKey" runat="server" /></td>
		<td><asp:textbox id="txtKey" cssclass="NormalTextBox" width="390" columns="30" maxlength="50" runat="server" /></td>
	</tr>
	<tr>
		<td class="SubHead" width="150"><scp:label id="plTitle" text="Title:" controlname="txtTitle" runat="server" /></td>
		<td><asp:textbox id="txtTitle" cssclass="NormalTextBox" width="390" columns="30" maxlength="50" runat="server" /></td>
	</tr>
	<tr>
		<td class="SubHead" width="150"><scp:label id="plSource" text="Source:" controlname="cboSource" runat="server" /></td>
	...
	<tr>
		<td class="SubHead" width="150"><scp:label id="plType" text="Type:" controlname="cboType" runat="server" /></td>
		<td>
	...
	<tr>
		<td class="SubHead" width="150"><scp:label id="plViewOrder" text="View Order:" controlname="txtViewOrder" runat="server" /></td>
		<td><asp:textbox id="txtViewOrder" cssclass="NormalTextBox" width="390" columns="30" maxlength="2"
				runat="server" /></td>
	</tr>
	<tr>
		<td class="SubHead" width="150"><scp:label id="plIcon" text="Icon:" controlname="cboIcon" runat="server" /></td>
	...
	<tr>
		<td class="SubHead" width="150"><scp:label id="plHelpURL" text="Help URL:" controlname="txtHelpURL" runat="server" /></td>
