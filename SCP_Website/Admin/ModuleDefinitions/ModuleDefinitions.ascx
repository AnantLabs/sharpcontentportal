<%@ Control CodeFile="ModuleDefinitions.ascx.cs" Language="C#" AutoEventWireup="true" Inherits="SharpContent.Modules.Admin.ModuleDefinitions.ModuleDefinitions" %>
...
<table border="0" cellpadding="2" cellspacing="2" summary="Module Definitions Design Table">
    <tr id="rowFeatures" runat="server">
        <td align="left" width="100%">
            <scp:SectionHead ID="dshFeatures" runat="server" CssClass="Head" IncludeRule="True" ResourceKey="Features" Section="divFeatures" Text="Features" />
    ...
    <tr>
        <td>
            <br />
            <scp:SectionHead ID="dshInstalled" runat="server" CssClass="Head" IncludeRule="True" ResourceKey="Installed" Section="divInstalled" Text="Installed Modules" />
            <div id="divInstalled" runat="Server">
                <asp:Label ID="lblUpdate" runat="server" CssClass="Normal" resourceKey="lblUpdate"></asp:Label>
                <br />
                <asp:DataGrid ID="grdDefinitions" runat="server" AutoGenerateColumns="False" BorderStyle="None" BorderWidth="0px" CellPadding="4" CellSpacing="4" EnableViewState="False" GridLines="None" summary="Module Defs Design Table">
    ...
    <tr>
        <td>
            <br />
            <scp:SectionHead ID="dshAvailable" runat="server" CssClass="Head" IncludeRule="True" ResourceKey="Available" Section="divAvailable" Text="Available Modules" />
            <div id="divAvailable" runat="server">
                ...
                <br />
                <scp:CommandButton ID="cmdInstall" runat="server" CausesValidation="False" ImageUrl="~/images/register.gif" ResourceKey="cmdInstall" />
                <br />
                <asp:PlaceHolder ID="phPaLogs" runat="server"></asp:PlaceHolder>
                <br />
                <scp:CommandButton ID="cmdRefresh" runat="server" CausesValidation="False" ImageUrl="~/images/refresh.gif" ResourceKey="cmdRefresh" Visible="false" />
            </div>
        </td>
    </tr>
</table>
