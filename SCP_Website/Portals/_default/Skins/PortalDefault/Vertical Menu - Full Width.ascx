                        ...
                        <table class="skinheader" cellspacing="0" cellpadding="3" width="100%" border="0">
                            <tr>
                                <td valign="top" align="left" nowrap>
                                    <scp:CURRENTDATE runat="server" ID="SCPCURRENTDATE" />
                                </td>
                        ...
                        <table cellspacing="3" cellpadding="3" width="100%" border="0">
                            ...
                            <tr valign="top">
                                <td class="leftpane" id="LeftPane" runat="server" valign="top" align="center">
                                    <scp:TREEVIEW ID="SCPTreeView" runat="server" BodyCssClass="Normal" CssClass="TreeViewMenu"
                                        HeaderCssClass="TreeViewMenu_Header" HeaderTextCssClass="Head" Level="root" NoWrap="true"
                                        TreeIndentWidth="5" />
                                    <br>
                                </td>
