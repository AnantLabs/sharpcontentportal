...
//scp.xml.JsDocument object ---------------------------------------------------------------------------------------------------------
	scp_xml.prototype.JsDocument = function ()
	{
		this.root = new scp.xml.JsXmlNode(this, '__root');
		this.childNodes = this.root.childNodes;
		this.currentHashCode=0;
	}

	scp_xml.prototype.JsDocument.prototype.hasChildNodes = function ()
	{
		return this.childNodes.length > 0;
	}
	
	scp_xml.prototype.JsDocument.prototype.loadXml = function (sXml)
	{
		var oParser = new scp.xml.JsParser();
		oParser.parse(sXml, this.root);
		return true;
	}

	scp_xml.prototype.JsDocument.prototype.getXml = function()
	{
		return this.root.getXml();
	}	

	scp_xml.prototype.JsDocument.prototype.findNode = function (oParent, sNodeName, sAttr, sValue)
	{
		//primitive for now...  
	...
	scp_xml.prototype.JsDocument.prototype.getNextHashCode = function ()
	{
...
/*
	function scp_xml_ChildNodes(oParent)
	{
		var ary = new Array();
		for (var i=0; i< oParent.childNodes.length; i++)
			ary[ary.length] = new scp_xml_XmlNode(oParent.childNodes[i]);
		return ary;
	}
*/

//scp.xml.JsXmlNode Object ---------------------------------------------------------------------------------------------------------

	scp_xml.prototype.JsXmlNode = function (ownerDocument, name)
	{
	...
	scp_xml.prototype.JsXmlNode.prototype.appendChild = function(oNode)
	{
		this.childNodes[this.childNodes.length] = oNode;
		oNode.parentNode = this;
	}

	scp_xml.prototype.JsXmlNode.prototype.removeChild = function(oNode)
	{
		var oParent = this;
	...
	scp_xml.prototype.JsXmlNode.prototype.hasChildNodes = function ()
	{
		return this.childNodes.length > 0;
	}
	
	scp_xml.prototype.JsXmlNode.prototype.getXml = function (oNode)
	{
		if (oNode == null)
			oNode = this;
	...
	scp_xml.prototype.JsXmlNode.prototype.getAttributes = function (oNode)
	{
		var sRet = '';
		for (var sAttr in oNode.attributes)
			sRet += ' ' + sAttr + '="' + scp.encodeHTML(oNode.attributes[sAttr]) + '"';					
		return sRet;
	}
	
	scp_xml.prototype.JsXmlNode.prototype.getAttribute = function (sAttr)
	{
		return this.attributes[sAttr];
	}

	scp_xml.prototype.JsXmlNode.prototype.setAttribute = function (sAttr, sVal)
	{
		this.attributes[sAttr] = sVal;
	}

	scp_xml.prototype.JsXmlNode.prototype.removeAttribute = function (sAttr)
	{
...
//sure a regular expression guru could make better
	scp_xml.prototype.JsParser = function ()
	{
		this.pos = null;
		this.xmlArray = null;
		this.root = null;
	...
	scp_xml.prototype.JsParser.prototype.parse = function(sXml, oRoot)
	{
		this.pos = 0;
	...
	scp_xml.prototype.JsParser.prototype.getProcessString = function ()
	{
	...
	scp_xml.prototype.JsParser.prototype.processXml = function (oParent)
	{
	...
	scp_xml.prototype.JsParser.prototype.isCloseTag = function()
	{
		var s = this.getProcessString();
	...
	scp_xml.prototype.JsParser.prototype.isOpenTag = function()
	{
		var s = this.getProcessString();
	...
	scp_xml.prototype.JsParser.prototype.processOpenTag = function(oParent)
	{		
		if (this.isOpenTag(this.getProcessString()))
		{
			var sArr = this.getProcessString().split(' ');
			var oNode = new scp.xml.JsXmlNode(oParent.ownerDocument);
	...
	scp_xml.prototype.JsParser.prototype.processAttributes = function(oNode)
	{
		var s = this.getProcessString();
		if (s.indexOf(' ') > -1)
			...
			for (var i=0; i<s.length; i++)
			{
				...
				if (sChar == '"')
				{
					if (bValue)
					{
						...
						oNode.attributes[sName] = scp.decodeHTML(sValue);
						sName = '';
						sValue = '';
						i++; //skip space
					}						
